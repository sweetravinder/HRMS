...
<aside class="sidebar">
  ...
  <div class="menu-section" data-key="sec-downtime">
    ...
    <div class="menu-items">
      ...
      <a href="downtime_add.php" class="<?= is_active('downtime_add.php') ? 'active' : '' ?>">Raise</a>
	    <!-- Missed punch requests (everyone can submit; manage shown to approvers/admin) -->
  <a href="punch_requests_my.php" class="<?= is_active('punch_requests_my.php') ? 'active' : '' ?>">Missed Punch Requests</a>
  <?php if (current_user_is_admin(db()) || has_cap('downtime.manage') || approver_pool_has('downtime', me_employee_id())): ?>
    <a href="punch_requests_manage.php" class="<?= is_active('punch_requests_manage.php') ? 'active' : '' ?>">Punch Requests (Manage)</a>
  <?php endif; ?>
  ...
  <div class="menu-section" data-key="sec-leaves">
    ...
    <div class="menu-items">
      ...
      <!-- Apply link removed from header; leaves.php contains apply form for employees -->
  ...
  <!-- Payroll -->
  <?php if ($isAdmin || has_cap('payroll.manage') || has_cap('payroll.view')): ?>
  <div class="menu-section" data-key="sec-payroll">
    <div class="menu-title" onclick="toggleMenu(this)">Payroll <span class="caret">▶</span></div>
    <div class="menu-items">
      <?php if ($isAdmin || has_cap('payroll.manage')): ?>
        <a href="payroll_list.php" class="<?= is_active('payroll_list.php') ? 'active' : '' ?>">Payroll Master</a>
        <a href="salary_master.php" class="<?= is_active('salary_master.php') ? 'active' : '' ?>">Salary Master</a>
      <?php endif; ?>
      <?php if ($isAdmin || has_cap('payroll.view')): ?>
